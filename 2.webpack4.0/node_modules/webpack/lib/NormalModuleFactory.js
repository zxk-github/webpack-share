...
class NormalModuleFactory extends Tapable {
	...
	create(data, callback) {
		...
		console.log("this.hooks.beforeResolve", this.hooks.beforeResolve)
		// []??
		this.hooks.beforeResolve.callAsync(
			...
			(err, result) => {
				...
				// 触发 factory事件流
				// console.log("this.hooks.factory", this.hooks.factory)
				// [ { type: 'sync', fn: [Function], name: 'NormalModuleFactory' } ]
