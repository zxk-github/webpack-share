...
module.exports = function(yargs, argv, convertOptions) {
	console.log("convert-argv yargs", yargs)
	console.log("convert-argv argv", argv.watch, argv.hot)
	// console.log("convert-argv convertOptions", convertOptions)
	var options = [];
	...
	function processConfiguredOptions(options) {
		...
		console.log("convert-argv.js, 输出的options", options)
		return options;
	}
