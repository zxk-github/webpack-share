...
const webpack = (options, callback) => {
	...
	if (Array.isArray(options)) {
		...
		// 在输入的webpack配置项基础上加了大量webpack默认设置
		// console.log('webpack.js 34 options', options)
		options = new WebpackOptionsDefaulter().process(options);
		// console.log('webpack.js 35 options', options)
